SELECT
    ...
    --timeStamp variables
    player_matches.gold_t[3] t_gold_sum_3,
    player_matches.gold_t[5] t_gold_sum_5,
    player_matches.gold_t[8] t_gold_sum_8,
    player_matches.gold_t[10] t_gold_sum_10,
    player_matches.gold_t[12] t_gold_sum_12,
    player_matches.gold_t[15] t_gold_sum_15,
    player_matches.gold_t[20] t_gold_sum_20,
    player_matches.gold_t[25] t_gold_sum_25,
    player_matches.gold_t[30] t_gold_sum_30,

    player_matches.lh_t[3] t_lasthits_sum_3,
    player_matches.lh_t[5] t_lasthits_sum_5,
    player_matches.lh_t[8] t_lasthits_sum_8,
    player_matches.lh_t[10] t_lasthits_sum_10,
    player_matches.lh_t[12] t_lasthits_sum_12,
    player_matches.lh_t[15] t_lasthits_sum_15,
    player_matches.lh_t[20] t_lasthits_sum_20,
    player_matches.lh_t[25] t_lasthits_sum_25,
    player_matches.lh_t[30] t_lasthits_sum_30,

    player_matches.xp_t[3] t_experience_sum_3,
    player_matches.xp_t[5] t_experience_sum_5,
    player_matches.xp_t[8] t_experience_sum_8,
    player_matches.xp_t[10] t_experience_sum_10,
    player_matches.xp_t[12] t_experience_sum_12,
    player_matches.xp_t[15] t_experience_sum_15,
    player_matches.xp_t[20] t_experience_sum_20,
    player_matches.xp_t[25] t_experience_sum_25,
    player_matches.xp_t[30] t_experience_sum_30,
